...
BM4Dtemp=fijifolder+"IVMDenoising"+File.separator+"BM3D"+File.separator;
...
setBatchMode("hide");
	...
	close();
	exec("C:/Program Files/MATLAB/"+matlabversion+"bin/matlab.exe -automation -sd "+BM4Dtemp+" -batch GAT_BM3D");
